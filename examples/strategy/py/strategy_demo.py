...
def on_quote(context, quote):
    # context.logger.info("position: {}".format(context.book.get_position(quote)))
    ...
    context.insert_order(quote.instrument_id, exchange, "15014990", price, 100, price_type, side, Offset.Open, HedgeFlag.Speculation)
