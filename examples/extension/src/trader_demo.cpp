...
TraderDemo::TraderDemo(bool low_latency, yijinjing::data::locator_ptr locator,
    ...
    : broker::Trader(low_latency, std::move(locator), "kfext_demo_td",
                     "kfext_demo_td") {
...
bool TraderDemo::insert_order(const event_ptr &event) { return false; }

bool TraderDemo::cancel_order(const event_ptr &event) { return false; }

bool TraderDemo::req_position() { return false; }

bool TraderDemo::req_account() { return false; }
} // namespace kungfu::wingchun::kfext_demo
