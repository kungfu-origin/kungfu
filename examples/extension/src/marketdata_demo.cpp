...
MarketDataDemo::MarketDataDemo(bool low_latency,
    ...
    : broker::MarketData(low_latency, std::move(locator), "kfext_demo") {
...
bool MarketDataDemo::subscribe(
    const std::vector<longfist::types::InstrumentKey> &instruments) {
  return false;
}

bool MarketDataDemo::subscribe_all() { return false; }

bool MarketDataDemo::unsubscribe(
    const std::vector<longfist::types::InstrumentKey> &instruments) {
  return false;
}
} // namespace kungfu::wingchun::kfext_demo
