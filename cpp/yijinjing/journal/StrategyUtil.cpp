...
int64_t StrategyUtil::writeStr(const string& str)
{
    return writer->writeStr(str);
}

int64_t StrategyUtil::write_frame(const void* data, FH_TYPE_LENGTH length, FH_TYPE_SOURCE source,
...
int64_t StrategyUtil::write_frame_extra(const void* data, FH_TYPE_LENGTH length, FH_TYPE_SOURCE source, FH_TYPE_MSG_TP msgType,
...
int64_t StrategyUtil::writePyData(uintptr_t data, FH_TYPE_LENGTH length, FH_TYPE_SOURCE source,
                               FH_TYPE_MSG_TP msgType, FH_TYPE_LASTFG lastFlag, FH_TYPE_REQ_ID requestId)
{
