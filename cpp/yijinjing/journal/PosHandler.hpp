...
/** pos will be updated to int64_t */
...
public:
    ...
    void print() const
    {
        ...
        {
            spdlog::info("[pos] (ticker)%s net:(t){}(a){}(y){} long:(t){}(a){}(y){} short:(t){}(a){}(y){}",
    ...
    inline void future_update(const string& ticker, VOLUME_DATA_TYPE volume, double price, LfDirectionType direction, LfOffsetFlagType offset)
    {
        ...
        switch (offset)
        {
            ...
            case LF_CHAR_LocalForceClose:
            {
                ...
                if (tot < (VOLUME_DATA_TYPE)(pos_array[POS_ARRAY_IDX(position_dir, YESTD_INDEX)]) || tot < 0)
                    is_poisoned = true;
