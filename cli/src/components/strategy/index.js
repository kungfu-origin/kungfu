...
import strategyTable from '@/assets/components/StrategyTable';
...
class StrategyDashboard extends Dashboard {
	...
	initTradeList(){
		...
		t.tradeTable = tradeTable.build({
	        ...
	        headers: ['UpdateTime', 'Ticker', 'Side', 'Offset', 'Price', 'Volume', 'AccountId']            
		});
	}
	...
	_afterSwitchStrategyProcess(index){
		...
		const strategyId = strategyProcess.strategy_id;
