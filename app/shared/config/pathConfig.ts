...
console.log('KF_CONFIG_PATH', KF_CONFIG_PATH)
console.log('DEFUALT_DB_PATH', DEFUALT_DB_PATH)
console.log('KF_HOME_BASE_DIR', KF_HOME_BASE_DIR)
console.log('KUNGFU_ENGINE_PATH', KUNGFU_ENGINE_PATH)
