...
class Watcher(pywingchun.Watcher):
    ...
    def on_assets(self, account_info, positions):
        ...
        account = Ledger(account_id = account_info.account_id, avail = account_info.avail, positions = {get_symbol_id(pos.instrument_id, pos.exchange_id): StockPosition(**to_dict(pos)) for pos in positions})
