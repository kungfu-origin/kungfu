...
namespace kungfu::wingchun::xtp
{
    ...
    public:
        ...
        XtpOrder get_order_by_xtp_order_id(const char *trading_day, const uint64_t xtp_order_id)
        {
            XtpOrder order = {};
            try
            {
        ...
        uint64_t get_xtp_order_id(const uint64_t internal_order_id)
        {
        ...
        uint64_t get_internal_order_id(const char *trading_day, const uint64_t xtp_order_id)
        {
