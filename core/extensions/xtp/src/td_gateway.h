...
namespace kungfu
{
    namespace wingchun
    {
        namespace xtp
        {
            class TdGateway : public XTP::API::TraderSpi, public gateway::Trader
            {
            public:
                TdGateway(bool low_latency, yijinjing::data::locator_ptr locator, std::map<std::string, std::string> &config_str, std::map<std::string, int> &config_int,
