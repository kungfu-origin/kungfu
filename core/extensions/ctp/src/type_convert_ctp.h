...
namespace kungfu
{
    namespace ctp
    {
        ...
        {
            nano_sec = kungfu::yijinjing::time::parseTime((std::string(date) + "-" + std::string(update_time)).c_str(), "%Y%m%d-%H:%M:%S");
        ...
        {
            n_secs = kungfu::yijinjing::time::parseTime((std::string(date) + "-" + std::string(time)).c_str(), "%Y%m%d-%H:%M:%S");
        }
