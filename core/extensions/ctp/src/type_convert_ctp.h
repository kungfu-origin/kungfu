...
namespace kungfu::wingchun::ctp {
    ...
    inline void
    to_ctp_price_type(TThostFtdcOrderPriceTypeType &price_type, TThostFtdcVolumeConditionType &volume_condition,
    ...
    inline void from_ctp_order_status(const TThostFtdcOrderStatusType &order_status,
                                      const TThostFtdcOrderSubmitStatusType &submit_status,
                                      OrderStatus &des) {
        switch (order_status) {
    ...
    inline void from_ctp(const CThostFtdcInstrumentCommissionRateField &ori, longfist::types::InstrumentCommissionRate &des) {
        strcpy(des.instrument_id, ori.InstrumentID);
