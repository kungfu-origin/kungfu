...
//            .def("add_book", &kwb::Bookkeeper::add_book)
//            .def("pop_book", &kwb::Bookkeeper::pop_book)
...
//            .def_property_readonly("book_manager", &Ledger::get_bookkeeper)
//            .def("now", &Ledger::now)
...
//            .def_property_readonly("book_manager", &strategy::Context::get_bookkeeper)
