...
PYBIND11_MODULE(pywingchun, m)
{
    ...
    py::class_<kf::Strategy, PyStrategy>(m, "Strategy")
            ...
            .def("get_name", &kf::Strategy::get_name)
            .def("configure_event_source", &kf::Strategy::configure_event_source)
            .def("handle", &kf::Strategy::handle)
            .def("finish", &kf::Strategy::finish)
