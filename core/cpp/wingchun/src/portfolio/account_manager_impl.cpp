...
namespace kungfu
{
    ...
    void AccountManagerImpl::on_positions(const std::vector<kungfu::flying::Position> &positions)
    {
        std::vector<kungfu::flying::Position> filtered;
    ...
    void AccountManagerImpl::on_position_details(const std::vector<kungfu::flying::Position> &details)
    {
