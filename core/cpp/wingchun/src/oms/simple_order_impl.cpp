    ...
    namespace wingchun
    {
        namespace oms
        {
            ...
            public:
                ...
                { return order_.account_id; }

                std::string get_client_id() const
                { return order_.client_id; }
                ...
                SimpleOrderUtil *get_util() const
                { return util_; };
                ...
                { return !is_final_status(get_status()); }

                OrderStatus get_status() const
                { return order_.status; }

                bool is_children_order() const
                { return order_.parent_id != 0; };

                uint64_t get_parent_id() const
                { return order_.parent_id; };
