    ...
    namespace wingchun
    {
        ...
        void EventLoop::handle(const yijinjing::event_ptr event)
        {
            ...
            switch (msg_type)
            {
                ...
                case msg::type::ReloadFutureInstrument:
                {
