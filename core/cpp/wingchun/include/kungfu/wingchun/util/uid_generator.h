...
namespace kungfu
{
    namespace wingchun
    {
        ...
        public:
            ...
            int64_t get_max_sequence() const
            { return this->max_sequence_; }

            int64_t get_max_delta_seconds() const
            { return this->max_delta_second_; }

            int64_t get_max_worker_id() const
            { return this->max_worker_id_; }
