...
namespace kungfu
{
    namespace wingchun
    {
        namespace oms
        {
            ...
            typedef std::shared_ptr<OmsOrder> OrderPtr;
            ...
            SimpleOrderPtr make_simple_order(const msg::data::OrderInput &input);

            SimpleOrderPtr make_simple_order(const msg::data::Order &order);

            class SimpleOrderUtil
            {
            public:
                virtual uint64_t submit(msg::data::OrderInput &input) = 0;
            ...
            public:
                ...
                virtual uint64_t submit_child_order(uint64_t order_id, msg::data::OrderInput &child_order_input) = 0;
                ...
                virtual bool try_frozen(uint64_t order_id, const std::string &account_id, const msg::nanomsg::AssetsFrozen &frozen)
                { return false; };
                ...
                //提交冻结接口
                virtual bool commit_frozen(uint64_t order_id, const std::string &account_id)
                { return false; };
                ...
                //@return 交易所交易时段
                virtual std::vector<msg::nanomsg::TradingSession>
                get_trading_sessions(long start_nano, long end_nano, const std::string &exchange_id) = 0;
            ...
            public:
                ...
                virtual void on_child_order(const msg::data::Order &order) = 0;

                //子订单成交通知
                //@param trade 子订单成交通知具体信息
                //@remark 子订单有成交，函数会被调用
                virtual void on_child_trade(const msg::data::Trade &trade) = 0;
            ...
            typedef std::shared_ptr<AlgoOrder> AlgoOrderPtr;
            ...
            public:
                ...
                {
                    static_assert(std::is_base_of<AlgoOrder, AlgoOrderDerived>::value,
                                  "AlgoOrderFactory::register_type doesn't accept this type because doesn't derive from AlgoOrder");
            ...
            private:
                ...
                AlgoOrderFactory &operator=(const AlgoOrderFactory &)
                { return *this; }
            };
