...
namespace kungfu
{
    namespace wingchun
    {
        ...
        public:
            ...
            const msg::data::Quote *const get_last_md(const std::string &instrument_id, const std::string &exchange_id) const;
            ...
            msg::data::Position get_position(const std::string &instrument_id, const std::string &exchange_id, Direction direction = DirectionLong,
                                          const std::string &account_id = "") const;

            msg::data::PortfolioInfo get_portfolio_info() const;

            msg::data::SubPortfolioInfo get_sub_portfolio_info(const std::string &account_id) const;
            ...
            //@param frozen        冻结请求内容
            //@return              操作ID
            uint64_t try_frozen(const std::string &account_id, const msg::nanomsg::AssetsFrozen &frozen);
            ...
            //@param frozen        冻结请求内容
            //@return              成功或者失败
            bool try_frozen(uint64_t op_id, const std::string &account_id, const msg::nanomsg::AssetsFrozen &frozen);
            ...
            uint64_t try_modify_position(const std::string &account_id, const msg::nanomsg::PositionModify &pos_modify);
