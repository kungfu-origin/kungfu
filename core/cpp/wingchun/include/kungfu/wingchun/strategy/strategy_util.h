...
namespace kungfu
{
    namespace wingchun
    {
        ...
        public:
            ...
            void
            subscribe(const std::string &source, const std::vector<std::string> &instruments, const std::string &exchange_id, bool is_level2 = false);
            ...
            uint64_t insert_order(msg::data::OrderInput &order_input);
        ...
        private:
            ...
            std::map<std::string, msg::data::Quote> quote_map_;
