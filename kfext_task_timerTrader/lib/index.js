...
var combineLatestObserver = Object(__WEBPACK_IMPORTED_MODULE_1_rxjs__["b" /* combineLatest */])(TIMER_COUNT_OBSERVER, PROCESS_MSG_OBSERVER, function (timeCount, plist) {
    return {
        timeCount: timeCount,
        plist: plist
    };
