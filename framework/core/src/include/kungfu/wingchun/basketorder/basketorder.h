...
// inline int64_t get_total_successfully_ordered_volume(const OrderMap &orders) {
...
struct BasketOrderState {
  ...
  void update_success_ordered_volume(const longfist::types::Order &order, int32_t instrument_key);
