import * as ACCOUNT_API from '@kungfu-trader/kungfu-uicc/io/kungfu/account';
import { TD_DIR, MD_DIR, buildGatewayPath } from '@kungfu-trader/kungfu-uicc/config/pathConfig';
import { removeFileFolder } from '@kungfu-trader/kungfu-uicc/utils/fileUtils';
import { startTd, startMd, deleteProcess } from '@kungfu-trader/kungfu-uicc/utils/processUtils';
